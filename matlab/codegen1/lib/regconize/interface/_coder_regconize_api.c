...
#include "_coder_regconize_mex.h"
 ...
 * Return Type  : void
 */
void regconize_api(const mxArray * const prhs[1], const mxArray *plhs[1])
{
  real_T (*X)[560];
  real_T Recog;
 ...
 * Return Type  : void
 */
void regconize_atexit(void)
{
  mexFunctionCreateRootTLS();
  emlrtEnterRtStackR2012b(emlrtRootTLSGlobal);
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
  regconize_xil_terminate();
}
 ...
 * Return Type  : void
 */
void regconize_initialize(void)
{
  mexFunctionCreateRootTLS();
...
/*
 * File trailer for _coder_regconize_api.c
 *
 * [EOF]
 */
